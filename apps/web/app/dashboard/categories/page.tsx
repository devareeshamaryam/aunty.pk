              ...
              <div>
                ...
                {formData.image && (
                  <div className="mb-2 w-20 h-20 relative">
                    <img src={getImageUrl(formData.image)} alt="Category" className="w-full h-full object-contain" />
                  </div>
                )}
                <input
                  type="file"
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Upload a clean PNG/icon for the category carousel</p>
              </div>
