...
import { Plus, Minus, Trash2, ShoppingBag, ArrowLeft, Heart, MessageCircle } from 'lucide-react'
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => updateQuantity(item.productId, item.quantity + 1, item.variant)}
                              className="w-8 h-8 rounded-lg bg-teal-500 hover:bg-teal-600 text-white flex items-center justify-center transition-colors"
                            >
                              <Plus size={16} />
                            </button>
                          </div>
              ...
              <div className="p-6 bg-gray-50 border-t border-gray-100">
                <Link
                  href="/"
                  className="flex items-center justify-center gap-2 text-teal-600 hover:text-teal-700 font-medium transition-colors"
                >
                  <Plus size={18} />
                  Continue Shopping
                </Link>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
              ...
              <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-100">
                ...
                <p className="text-sm text-teal-700">
                  Get your order delivered for free within 2-3 business days
                </p>
              </div>
            </div>
          </div>
