              ...
              <div className="flex items-center justify-between h-16 relative">
                ...
                <div className="flex items-center flex-1 gap-3">
                  ...
                  <Link href="/" className="block group md:hidden">
                    <div className="w-14 h-14 rounded-full overflow-hidden transition-transform duration-300 group-hover:scale-105" style={{ filter: 'drop-shadow(0 2px 8px rgba(0,0,0,0.18))' }}>
                      <Image src="/image.png" alt="Aunty.pk Logo" width={56} height={56} className="w-full h-full object-cover scale-150" />
                    </div>
                  </Link>
                </div>
                ...
                <div className="flex-1 flex items-center justify-end gap-3">
                  <a href="tel:03105717097" className="md:hidden p-1 text-teal-500 hover:text-teal-600 transition-colors">
                    <Phone className="w-6 h-6" />
                  </a>
                  <button onClick={onCartOpen} className="relative p-1">
                    <ShoppingCart className="w-6 h-6 sm:w-7 sm:h-7 text-teal-500 hover:text-teal-600 transition-colors" strokeWidth={2} />
                    {totalItems > 0 && (
